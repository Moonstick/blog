...
const AboutPage = () => {
  return (
    <Layout pageTitle="About Me">
      <p>Hi, my name is David O'Brien and I'm working as a software consultant which generally involves working teams of people to design and build systems. I'm currently working for <a href="http://www.codurance.com">Codurance</a> as one of their Principal Craftsman.</p>
      ...
      <p>This blog is very much a work in progress; I'm not the most artistic but I'll endeavour to make it look a least a little bit nicer soon!</p>
    </Layout>
  )
}
