...
description: "Understanding the Strategy pattern — how to encapsulate interchangeable algorithms behind a common interface, making behaviour easy to swap at runtime."
